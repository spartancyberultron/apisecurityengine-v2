...
public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
{
    ...
    return (
        <div  style={{ overflow: "scroll", position: 'relative', overflowY: 'hidden', overflowX: 'hidden', }}>
            <div style={{ width: '100%' }}>
                <div>
                    <div style={{ marginBottom: '2rem', display: 'flex', flexDirection: 'row', justifyContent: 'space-around', marginTop:20 }}>

                        <h2>Add a Traffic Mirroring Agent into Your Project</h2>
