...
const SSDLCScore = () => {
    ...
    const data = {
        categories: ['Number of Vulnerabilities', 'Breach Assessment Score'],
        values: [35, 80], // Example data
      };
    ...
    return (
        ...
        <div className="theCards" style={{
            ...
            <div >
                ...
                <span style={{ color: '#5D596C', textAlign: 'left', marginTop: 10, fontSize: 18, display: 'block' }}>SSDLC Score</span>
                <span style={{ fontSize: 13, textAlign: 'left', alignSelf: 'left', color: 'rgb(165, 163, 174', display: 'block' }}>
                    SSDLC Score according to the number of vulnerabilities with breach assessment score</span>
