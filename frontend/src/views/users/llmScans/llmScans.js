...
const LLMScans = () => {
  ...
  const goToViewReport = async (scanId) => {
    ...
    navigate('/view-llm-scan-report?scanId=' + scanId);
  };
    ...
    <div className="activeScans">
      ...
      <div style={{ width: '100%' }}>
        <div>
          ...
          <span className="pageHeader">LLM Scans</span>

            <CButton
              className="primaryButton"
              
              onClick={goToStartLLMScan}
              color="primary"
            >
              <AiOutlineSecurityScan size={20} color='white'/>

              <span className="primaryButtonText" style={{marginLeft:10}}>Start LLM Scan</span>
            </CButton>
          </div>
